...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/legged-locomotion-in-bots/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/legged-locomotion-in-bots/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/legged-locomotion-in-bots.git
